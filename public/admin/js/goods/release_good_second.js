...
//		else  $(".h50").hide();
	...
	$(".edit-sku-popup-body article>div.sku-display-mode>ul li input[type='color']").live("change",function(){
		var curr_sku = $(".edit-sku-popup-body aside>ul li.selected.curr");
		var spec_value = eval(curr_sku.attr("data-spec-value-json"));
		if(spec_value != null){
...
//		$("#btnSave,#btnSavePreview").attr("disabled", "disabled");
		...
		console.log(productViewObj.is_hot);
...
function PackageProductInfo() {
	...
	productViewObj.is_hot = $("input[name='is_hot']:checked").val();// 热卖
	...
	//二维码背景图
    productViewObj.background_img = $("#Logo").val();

    //不销售区域
    //productViewObj.no_sale_place = $("#no_sale_place").val();


    var groupCheckbox=$('#citySelect').find("input[name='city']");
    var city='';
    ...
    productViewObj.no_sale_place =city;
