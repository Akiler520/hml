...
$arr = array( 'account' => 'm18997371376@163.com', 'password' => 'mima888888' );
$w = new Weixin($arr);
 
$re = $w->getAllUserInfo();//获取所有用户信息
...
class Weixin {
    ...
    private function login(){
        ...
        foreach ($result as $key => $value) {
            ...
            if (preg_match('/"ret":(.*)/i', $value,$match))
			{//获取token
                switch ($match[1]) {
                    case -1:
