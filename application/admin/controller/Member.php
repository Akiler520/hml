...
class Member extends BaseController
{
    ...
    {
        if (request()->isAjax()) {
            $start_date = request()->post('start_date') == "" ? mktime(0,0,0,date('m'),1,date('Y')) : getTimeTurnTimeStamp(request()->post('start_date'));
            $end_date = request()->post('end_date') == "" ? mktime(23,59,59,date('m'),date('t'),date('Y')) : getTimeTurnTimeStamp(request()->post('end_date'));
            ...
            $list = $order_service->getFanliList(  $condition,'create_time desc');
        ...
        return view($this->style . "Member/fanliList");
    ...
    public function fanliInfo()
    {
        if (request()->isAjax()) {
            ...
            $condition["fl_state"]=0;
            $order_service = new OrderService();
            $list = $order_service->getFanliInfo(  $condition,'fl_id desc');
        ...
        return view($this->style . "Member/shujuList");
    ...
    public function shengcheng(){
        ...
        $order_service = new OrderService();
        $retval = $order_service->addShengcheng($user_id,$start_date,$end_date);
        return AjaxReturn($retval);
    }

    //全部会员返利
    public function qbsc(){
        $start_date = request()->post('start_date') == "" ? mktime(0,0,0,date('m'),1,date('Y')) : getTimeTurnTimeStamp(request()->post('start_date'));
        $end_date = request()->post('end_date') == "" ? mktime(23,59,59,date('m'),date('t'),date('Y')) : getTimeTurnTimeStamp(request()->post('end_date'));
        ...
        $order_service = new OrderService();
        $retval = $order_service->shengchengAll($user_id,$start_date,$end_date);
        return AjaxReturn($retval);
    }

    //一键生成
    public function yjsc(){
        $start_date = request()->post('start_date') == "" ? mktime(0,0,0,date('m'),1,date('Y')) : getTimeTurnTimeStamp(request()->post('start_date'));
        $end_date = request()->post('end_date') == "" ? mktime(23,59,59,date('m'),date('t'),date('Y')) : getTimeTurnTimeStamp(request()->post('end_date'));
        ...
        $order_service = new OrderService();
        $retval = $order_service->yjsc($user_id_list,$start_date,$end_date);
        return AjaxReturn($retval);
    ...
    public function yjfl(){
        ...
        $member = new MemberService();
        $retval = $member->yjfl($start_date,$end_date);
        //return AjaxReturn($retval);
        return $retval;
    }
