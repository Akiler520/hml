    ...
    public function payConfig()
    {
        ...
        if (request()->isAjax()) {
            ...
            if ($type == 'wchat') {
                ...
                // 获取当前域名
                $root_url = __URL(__URL__ . "/wap/pay/getPayValue");
