...
use data\model\NsPromotionYifenGoodsViewModel;
 ...
 *        
 */
class GoodsYifen extends BaseService
{
     ...
     */
    public function getGoodsIsYifen($goods_id, $start_time, $end_time)
    {
        $discount_goods = new NsPromotionYifenGoodsModel();
        $condition_1 = array(
            'start_time' => array(
                'ELT',
                $end_time
     ...
     * @param unknown $goods_id            
     */
    public function getYifenByGoodsid($goods_id)
    {
        $discount_goods = new NsPromotionYifenGoodsModel();
